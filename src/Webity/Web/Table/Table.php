<?php
namespace Webity\Web\Table;

use Webity\Web\Application\WebApp;
use Webity\Web\Object\Object;
...
abstract class Table extends Object
{
	...
	public static function getInstance($type, $config = array())
	{
		...
		// If a database object was passed in the configuration array use it, otherwise get the global one from WebApp.
		$db = isset($config['dbo']) ? $config['dbo'] : WebApp::getInstance()->getDbo();
